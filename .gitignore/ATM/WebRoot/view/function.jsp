...
<html>
  <head>
    ...
    <link href="files/function/styles.css" type="text/css" rel="stylesheet"/>
    ...
    <script src="files/function/data.js"></script>
  ...
  <body>
    <div id="base" class="">
      ...
      <div id="u22" class="ax_default image">
        <img id="u22_img" class="img " src="images/login/u0.jpg"/>
        <!-- Unnamed () -->

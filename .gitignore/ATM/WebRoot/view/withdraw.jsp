...
<html>
  <head>
    ...
    <link href="files/withdraw/styles.css" type="text/css" rel="stylesheet"/>
    ...
    <script src="files/withdraw/data.js"></script>
  ...
  <body>
    <div id="base" class="">
      ...
      <div id="u69" class="ax_default image">
        <img id="u69_img" class="img " src="images/login/u0.jpg"/>
        <!-- Unnamed () -->
      ...
      <div id="u87" class="ax_default _二级标题">
        ...
        <div id="u88" class="text" style="visibility: visible;">
          <p><span>输入取款金额：</span></p>
        </div>
      </div>

      <!-- Unnamed (文本框) -->
      <div id="u89" class="ax_default text_field">
        <input id="u89_input" type="text" value=""/>
      </div>
